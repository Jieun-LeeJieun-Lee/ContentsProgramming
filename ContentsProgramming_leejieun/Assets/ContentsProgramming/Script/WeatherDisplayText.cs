...
public class WeatherTextDisplay : MonoBehaviour
{
    ...
    public void ChangeToSummer()
    {
        ...
        locationName = "Summer Busan";
        Debug.Log("Summer: " + currentTemperature + "C");
    }
    ...
    public void ChangeToAutumn()
    {
        ...
        locationName = "Autumn KyeongJu";
        Debug.Log("Autumn: " + currentTemperature + "c");
    }
    ...
    public void ChangeToWinter()
    {
        ...
        locationName = "Winter Kangwon";
        Debug.Log("Winter: " + currentTemperature + "C");
    }
}